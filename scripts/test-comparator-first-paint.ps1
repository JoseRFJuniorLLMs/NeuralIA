param(
    ...
    # separa "lento" de "parado". O prazo fixo de 12 s que havia aqui falhou
    # nos runs 36169172174 e 36252161943 com 1 superficie em 0,76,341,720:
    # e o estado do produto enquanto o WebView2 da coluna 0 ainda arranca.
