...
pub use book::{
    ...
    MAX_ATTR_CHARS, MAX_FIELD_CHARS, MAX_MEDIA_TYPE_CHARS, MAX_METADATA_ITEMS,
    MAX_METADATA_REFINES, MAX_SPINE_ITEMS, MAX_WARNINGS, ManifestItem, PageProgression, SpineItem,
};
